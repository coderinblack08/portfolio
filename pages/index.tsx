  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center my-20 container mx-auto">
        ...
        <div
          className="cursor-pointer xl:cursor-auto flex items-center flex-col xl:flex-row-reverse mt-10 py-10 rounded"
          onClick={() => {
            if (window.innerWidth < 768) {
        ...
        >
          <img
            ...
            src="../static/contestpug.png"
            alt="Coderinblack Academy"
          />
          <div className="xl:mr-20 mt-10 text-center xl:text-left xl:mt-0">
            ...
            <p className="font-quicksand text-xl my-2 mb-4 text-gray-800 max-w-xs sm:max-w-xl">
              ...
              contestants host and take competitions online. Created with 💖 in
              GraphQL, Postgres, Nextjs, and Typescript!
            </p>
            <a
